...
namespace NaturalUruguayGateway.DataAccess.Migrations
{
    ...
    [Migration("20201012032536_UpdateCompleteBookingTableMigration")]
    partial class UpdateCompleteBookingTableMigration
    {
            ...
            modelBuilder.Entity("Domain.Booking", b =>
                {
                    ...
                    b.HasOne("Domain.Lodgment", "Lodgment")
                        .WithMany()
